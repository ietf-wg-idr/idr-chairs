...
- Re-chartering is in progress.
  ...
  - Ketan is currently editing the new charter. 
-----
## At RFC Editor
...
* [draft-ietf-idr-vpn-prefix-orf](https://datatracker.ietf.org/doc/draft-ietf-idr-vpn-prefix-orf/)   
  **Shepherd**: Keyur - Submitted **7 November, 2025**.  
  AD feedback returned **22 November, 2025**.  Authors returned update, Next Step: AD reviews 
...
1. [draft-ietf-idr-rt-derived-community](https://datatracker.ietf.org/doc/draft-ietf-idr-rt-derived-community/),  
    **Shepherd:** Jie Dong, (**WG LC 12/11 to 1/5**)
  
2. [draft-ietf-idr-nhc](https://datatracker.ietf.org/doc/draft-ietf-idr-nhc/) **WG LC time 12/22/2025 to 1/12/2025)** 
   **Shepherd:** Susan Hares (Shepherd's report and WG LC on 12/22) 
...
3. [draft-ietf-idr-sr-policy-seglist-id](https://datatracker.ietf.org/doc/draft-ietf-idr-sr-policy-seglist-id/),
   **Shepherd:** Sue, pending -07, IANA early allocation done, WG LC IPR Call started (1/5/2026 to 1/12/2026) 
   
----
## WG LC Pending for Core BGP + FSv1 
1. [draft-ietf-idr-4360-bis](https://datatracker.ietf.org/doc/draft-ietf-idr-rfc4360-bis/)  
   **Shepherd:** Keyur  
   Status: Keyur to start WGLC (**8 December, 2025**). RTG-DIR OK (1/5/2026), Need to fill out implementation page on wiki (Sue, 1/4/2026)
...
5. [draft-ietf-idr-5g-edge-service-metadata](https://datatracker.ietf.org/doc/draft-ietf-idr-5g-edge-service-metadata/)  
...
6. [draft-ietf-idr-linklocal-capability](https://datatracker.ietf.org/doc/draft-ietf-idr-linklocal-capability/) - Jie and Chairs to review for suitability to move to WGLC.
   **Shepherd:** Jie Dong
   
7. [draft-ietf-idr-wide-bgp-communities-12](https://datatracker.ietf.org/doc/draft-ietf-idr-wide-bgp-communities/)  
   **Shepherd:** Sue –**Needs -13**
   
8. [draft-ietf-idr-registered-wide-bgp-communities-03](https://datatracker.ietf.org/doc/draft-ietf-idr-registered-wide-bgp-communities/)  
   **Shepherd:** Sue – **Needs -04** 
   
9. [draft-ietf-idr-elc-00](https://datatracker.ietf.org/doc/draft-ietf-idr-elc/)  
     **Shepherd:** Sue – **Needs 2nd implementation**

10. [draft-ietf-idr-bgp-fsm-iana](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp-fsm-iana/) | Sue Hares 
      **Shepherd:** Sue – awaiting 01 – Needs Jeff’s edits 
11. [draft-ietf-idr-bgp-bfd-strict-mode-15](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp-bfd-strict-mode)  
      **Shepherd:** Sue  
      Needs new shepherd Review and IANA.  Jeff needs to do code audit.
12. [draft-ietf-bess-ebgp-dmz-08](https://datatracker.ietf.org/doc/draft-ietf-bess-ebgp-dmz/)  
      **Shepherd:** Jeff Haas (14 November, 2025) - Mutual WGLC between BESS and IDR proposed. Jeff will query BESS chairs on being the shepherd.
...
1. [draft-ietf-idr-sr-policy-seglist-id](https://datatracker.ietf.org/doc/draft-ietf-idr-sr-policy-seglist-id/),
   **Shepherd:** Sue, pending -06, Needs -07 before WG LC.  IPR for WG LC in progress (1/5/2026 to 1/12/2026) - WG LC ETA: 1/12/2026 
...
3. [draft-ietf-idr-sr-bgp-sr-mpls-elp](https://datatracker.ietf.org/doc/draft-ietf-idr-sr-bgp-sr-mpls-elp)
    **Shepherd:** Sue, [Shepherd report on IDR wiki](https://wiki.ietf.org/e/en/group/idr/Shepherd-SR-BGP-LS/BGP-SR/draft-ietf-idr-bgp-sr-mpls-elp). IANA done (17), **Needs [-05] prior to WG LC** - January WG LC ETA: 1/12/2026 
...
3. [draft-ietf-idr-bgp-ls-sr-policy-path-segment](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp-ls-sr-policy-path-segment/)  
    **Shepherd:** Sue; [Shepherd's report in IDR wiki](https://wiki.ietf.org/group/idr/Shepherd-SR-BGP-LS/BGP-LS-SR/bgp-ls-sr-policy-path-segments)  
     **Holding on** [draft-ietf-idr-sr-policy-path-segment] early allocation discussion with Ketan.
...
4. [draft-ietf-idr-bgp-ls-isis-flood-reflection-04](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp-ls-isis-flood-reflection/),  
    **Shepherd:** Sue, ** Waiting on -05**, 2 implementations, asking if authors still interested
  
5. [draft-ietf-idr-sr-epe-over-l2bundle](https://datatracker.ietf.org/doc/draft-ietf-idr-sr-epe-over-l2bundle/)
    **Shepherd:** Sue,  **Waiting on -02**, 2 implementations
...
3. [draft-litowski-idr-rtc-interas-03](https://datatracker.ietf.org/doc/draft-litowski-idr-rtc-interas/) - Requested on **4 November, 2025** (IETF-124) 
...
5. [draft-lin-idr-sr-policy-admin-flags-03](https://datatracker.ietf.org/doc/draft-lin-idr-sr-policy-admin-flags/) - **Needs -04** prior to adoptoin. 
   
6. [draft-liu-idr-sr-segment-list-optimize-01](https://datatracker.ietf.org/doc/draft-liu-idr-sr-segment-list-optimize-01) - **Needs -02**, Spring thought good idea. 

7. [draft-zhang-idr-sr-policy-template](https://datatracker.ietf.org/doc/draft-zhang-idr-sr-policy-template/): **Need Cross-WG summary** from authors (copied Spring and PCE chairs) 

8. [draft-zzd-idr-sr-policy-scheduling-10](https://datatracker.ietf.org/doc/draft-zzd-idr-sr-policy-scheduling) 
...
1. [draft-ali-idr-srv6-policy-sl-opt-distribution-00](https://datatracker.ietf.org/doc/draft-ali-idr-srv6-policy-sl-opt-distribution/) - [(-00) to (-01)](/group/idr/Shepherd-SR-BGP-LS/BGP-LS/draft-ali-idr-sr-policy-sl-opt-distribution)  - **pending -01 Review**
...
6. [draft-li-idr-bgpls-sr-policy-composite-path](https://datatracker.ietf.org/doc/draft-li-idr-bgpls-sr-policy-composite-path/) [(-06) to (-08)](/group/idr/Shepherd-SR-BGP-LS/BGP-LS-SR/draft-li-idr-bgpls-sr-policy-composite-path)  -  **Depend on BGP SR draft** draft-jiang-idr-sr-policy-composite-path being adopted. 

7. [draft-lin-idr-bgpls-te-policy-pm](https://datatracker.ietf.org/doc/draft-lin-idr-bgpls-te-policy-pm) - [(-03) to (-04)](/group/idr/Shepherd-SR-BGP-LS/BGP-LS-SR/draft-lin-idr-bgpls-te-policy-pm) - **checking if authors are still interested** 

8. [draft-lin-idr-bgp-ls-sr-policy-admin-flag](https://datatracker.ietf.org/doc/draft-lin-idr-bgp-ls-sr-policy-admin-flag/)  - [(-01) to (-02)](/group/idr/Shepherd-SR-BGP-LS/BGP-LS/draft-lin-idr-bgp-ls-sr-policy-admin-flags) - **pending -02 review** 

9. [draft-liu-idr-bgpls-sr-p2mp-policy-distribution](https://datatracker.ietf.org/doc/draft-liu-idr-bgpls-sr-p2mp-policy-distribution/) - [(-03) to -(-04)](/group/idr/Shepherd-SR-BGP-LS/BGP-LS-SR/draft-liu-idr-bgpls-sr-p2mp-policy-distribution/) - **check if authors still interested** 

10. [draft-liu-idr-bgp-ls-srp-flexible-path-selection](https://datatracker.ietf.org/doc/draft-liu-idr-bgp-ls-srp-flexible-path-selection/) - [(-00) to (-01)](/group/idr/Shepherd-SR-BGP-LS/BGP-LS-SR/draft-liu-idr-bgp-ls-srp-flexible-path-selection) - **Needs -02** before adoption 

11. [draft-tong-idr-bgp-ls-savnet](https://datatracker.ietf.org/doc/draft-tong-idr-bgp-ls-savnet/)  [(-00)](/group/idr/Shepherd-SR-BGP-LS/BGP-LS/draft-tong-idr-bgp-ls-savenet) - **pending review of -00**
...
- [draft-ietf-idr-bgp-ls-sr-policy-nrp](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp-ls-sr-policy-nrp/)  **Needs -03** - to st WG LC 
- [draft-ietf-idr-bgp-ls-sr-policy-path-segment](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp-ls-sr-policy-path-segment/) - **Needs Ok** for linked SR draft
...
* [draft-ietf-idr-bgp-ls-te-path](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp-ls-te-path/)  - *&Needs 03**, draft expired 
...
* [draft-ietf-idr-dynamic-cap](https://datatracker.ietf.org/doc/draft-ietf-idr-dynamic-cap/)
...
* [draft-ietf-idr-bgp4-rfc4271bis](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp4-rfc4271bis/)  
  ...
  Editor has provided initial document including conversion of RFC 4271 and incorporating open Errata.  
  Discussion pending about how to best incorporate [open issues](https://github.com/ietf-wg-idr/RFC4271bis/issues).
