...
9. [draft-ietf-idr-bgp-fsm-iana](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp-fsm-iana/)  
    **Shepherd:** Susan Hares 
    **Status:** *Needs -01*. Awaiting 01 after BFD resolution.

10. [draft-ietf-idr-bgp-bfd-strict-mode-15](https://datatracker.ietf.org/doc/draft-ietf-idr-bgp-bfd-strict-mode)  
    **Shepherd:** Susan Hares  
...
8. [draft-zzd-idr-sr-policy-scheduling-10](https://datatracker.ietf.org/doc/draft-zzd-idr-sr-policy-scheduling) main author: [Minxue Wang/Li Zhang] – *Needs -11* and discussion in IDR sessions.
